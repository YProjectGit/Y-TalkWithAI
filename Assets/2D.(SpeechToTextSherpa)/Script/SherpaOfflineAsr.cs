...
{
    public string modelDirectoryRelativePath = "2D.(SpeechToTextSherpa)/Resource/models"; // Assets/ からの相対
    public string encoderFileName = "encoder-epoch-99-avg-1.int8.onnx";
    public string decoderFileName = "decoder-epoch-99-avg-1.int8.onnx";

...
2. sherpa-onnx のモデルとネイティブライブラリを配置してください。  
   手順 → [Assets/Docs/sherpa-onnx-setup.md](../Docs/sherpa-onnx-setup.md)
...
Project ウィンドウで `Assets/2D.(SpeechToTextSherpa)/SpeechToTextSherpa.unity` を開き、Play を押してください。
